...
$GLOBALS['TL_LANG']['tl_content']['alt']           = array('Alternativer Text', 'Hier können Sie einen alternativen Text für das Bild eingeben (<em>alt</em>-Attribut).');
$GLOBALS['TL_LANG']['tl_content']['title']         = array('Titel', 'Hier können Sie den Titel des Bildes eingeben (<em>title</em>-Attribut).');
$GLOBALS['TL_LANG']['tl_content']['size']          = array('Bildbreite und Bildhöhe', 'Hier können Sie die Abmessungen des Bildes und den Skalierungsmodus festlegen.');
...
$GLOBALS['TL_LANG']['tl_content']['imageUrl']      = array('Bildlink-Adresse', 'Eine eigene Bildlink-Adresse überschreibt den Lightbox-Link, so dass das Bild nicht mehr in der Großansicht dargestellt werden kann.');
...
$GLOBALS['TL_LANG']['tl_content']['code']          = array('Code', 'Beachten Sie, dass der Code nicht ausgeführt wird. Mit F11 können Sie den Vollbildmodus aufrufen, wenn Sie den Code-Editor nutzen.');

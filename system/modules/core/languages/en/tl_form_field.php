...
$GLOBALS['TL_LANG']['tl_form_field']['tabindex']       = array('Tab index', 'The position of the form field in the tabbing order.');
$GLOBALS['TL_LANG']['tl_form_field']['fSize']          = array('Field size', 'Here you can enter the size of the upload field (size attribute).');
...
$GLOBALS['TL_LANG']['tl_form_field']['pasteend']   = array('Add new at the end', 'Add new after the last field');
